...
export function MultipleSkillSelectorItems({
  selectedItems = [],
  setSelectedItems,
  error,
  className,
  ...
  selectedItems: Item2[];
  setSelectedItems: React.Dispatch<React.SetStateAction<Item2[]>>;
  error?: string;
  className?: string;
}) {
  const [selected, setSelected] = useState<Item2>({ name: "", id: "" });
  const [query, setQuery] = useState("");
                    ...
                    item && (
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={() =>
                            setSelectedItems(
                              selectedItems.filter((_, index) => index !== i),
                            )
                          }
                        >
                          <XMarkIcon className="h-4 w-4" />
